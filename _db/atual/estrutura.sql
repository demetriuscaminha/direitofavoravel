...
--
-- Host: 10.129.76.12
-- Tempo de geração: 07/03/2019 às 16:40
...
--
-- Banco de dados: `direitofav`
--

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_actions`
--

CREATE TABLE IF NOT EXISTS `dfav_actions` (
...
--
-- Estrutura para tabela `dfav_authmap`
--

CREATE TABLE IF NOT EXISTS `dfav_authmap` (
...
--
-- Estrutura para tabela `dfav_batch`
--

CREATE TABLE IF NOT EXISTS `dfav_batch` (
...
--
-- Estrutura para tabela `dfav_block`
--

CREATE TABLE IF NOT EXISTS `dfav_block` (
...
--
-- Estrutura para tabela `dfav_blocked_ips`
--

CREATE TABLE IF NOT EXISTS `dfav_blocked_ips` (
...
--
-- Estrutura para tabela `dfav_block_custom`
--

CREATE TABLE IF NOT EXISTS `dfav_block_custom` (
...
--
-- Estrutura para tabela `dfav_block_node_type`
--

CREATE TABLE IF NOT EXISTS `dfav_block_node_type` (
...
--
-- Estrutura para tabela `dfav_block_role`
--

CREATE TABLE IF NOT EXISTS `dfav_block_role` (
  `module` varchar(64) NOT NULL COMMENT 'The block’s origin module, from dfav_block.module.',
  `delta` varchar(32) NOT NULL COMMENT 'The block’s unique delta within module, from dfav_block.delta.',
...
--
-- Estrutura para tabela `dfav_cache`
--

CREATE TABLE IF NOT EXISTS `dfav_cache` (
...
--
-- Estrutura para tabela `dfav_cache_admin_menu`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_admin_menu` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_block`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_block` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_bootstrap`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_bootstrap` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_field`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_field` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_filter`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_filter` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_form`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_form` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_image`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_image` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_libraries`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_libraries` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_menu`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_menu` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_metatag`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_metatag` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_page`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_page` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_path`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_path` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_token`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_token` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_update`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_update` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_variable`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_variable` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_views`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_views` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_cache_views_data`
--

CREATE TABLE IF NOT EXISTS `dfav_cache_views_data` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
--
-- Estrutura para tabela `dfav_ckeditor_input_format`
--

CREATE TABLE IF NOT EXISTS `dfav_ckeditor_input_format` (
...
--
-- Estrutura para tabela `dfav_ckeditor_settings`
--

CREATE TABLE IF NOT EXISTS `dfav_ckeditor_settings` (
...
--
-- Estrutura para tabela `dfav_clientside_validation_settings`
--

CREATE TABLE IF NOT EXISTS `dfav_clientside_validation_settings` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Table for storing Clientside Validation Settings' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_conditional_fields`
--

CREATE TABLE IF NOT EXISTS `dfav_conditional_fields` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores dependencies between fields.' AUTO_INCREMENT=12 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_ctools_css_cache`
--

CREATE TABLE IF NOT EXISTS `dfav_ctools_css_cache` (
...
--
-- Estrutura para tabela `dfav_ctools_object_cache`
--

CREATE TABLE IF NOT EXISTS `dfav_ctools_object_cache` (
...
--
-- Estrutura para tabela `dfav_date_formats`
--

CREATE TABLE IF NOT EXISTS `dfav_date_formats` (
...
--
-- Estrutura para tabela `dfav_date_format_locale`
--

CREATE TABLE IF NOT EXISTS `dfav_date_format_locale` (
  `format` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'The date format string.',
  `type` varchar(64) NOT NULL COMMENT 'The date format type, e.g. medium.',
...
--
-- Estrutura para tabela `dfav_date_format_type`
--

CREATE TABLE IF NOT EXISTS `dfav_date_format_type` (
  `type` varchar(64) NOT NULL COMMENT 'The date format type, e.g. medium.',
...
--
-- Estrutura para tabela `dfav_ds_fields`
--

CREATE TABLE IF NOT EXISTS `dfav_ds_fields` (
...
--
-- Estrutura para tabela `dfav_ds_field_settings`
--

CREATE TABLE IF NOT EXISTS `dfav_ds_field_settings` (
...
--
-- Estrutura para tabela `dfav_ds_layout_settings`
--

CREATE TABLE IF NOT EXISTS `dfav_ds_layout_settings` (
...
--
-- Estrutura para tabela `dfav_ds_vd`
--

CREATE TABLE IF NOT EXISTS `dfav_ds_vd` (
...
--
-- Estrutura para tabela `dfav_ds_view_modes`
--

CREATE TABLE IF NOT EXISTS `dfav_ds_view_modes` (
...
--
-- Estrutura para tabela `dfav_field_collection_item`
--

CREATE TABLE IF NOT EXISTS `dfav_field_collection_item` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores information about field collection items.' AUTO_INCREMENT=12 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_collection_item_revision`
--

CREATE TABLE IF NOT EXISTS `dfav_field_collection_item_revision` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores revision information about field collection items.' AUTO_INCREMENT=12 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_config`
--

CREATE TABLE IF NOT EXISTS `dfav_field_config` (
...
--
-- Estrutura para tabela `dfav_field_config_instance`
--

CREATE TABLE IF NOT EXISTS `dfav_field_config_instance` (
...
--
-- Estrutura para tabela `dfav_field_data_body`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_body` (
...
--
-- Estrutura para tabela `dfav_field_data_field_alvo`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_alvo` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_area_ref`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_area_ref` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_area_ref_tid` int(10) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 40 (field_area_ref)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_data_field_category`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_category` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_date`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_date` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_days_shifts`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_days_shifts` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_duration`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_duration` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_duration_value` varchar(100) DEFAULT NULL,
  `field_duration_format` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 39 (field_duration)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_data_field_email`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_email` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_facilitator_nr`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_facilitator_nr` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_facilitator_nr_nid` int(10) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 33 (field_facilitator_nr)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_data_field_file`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_file` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_image`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_image` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_info_fc`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_info_fc` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_info_fc_value` int(11) DEFAULT NULL COMMENT 'The field collection item id.',
  `field_info_fc_revision_id` int(11) DEFAULT NULL COMMENT 'The field collection item revision id.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 35 (field_info_fc)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_data_field_info_left_sub_title`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_info_left_sub_title` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_info_left_title`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_info_left_title` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_info_right_sub_title`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_info_right_sub_title` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_info_right_title`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_info_right_title` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_investment`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_investment` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_link`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_link` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_links_fc`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_links_fc` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_link_2`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_link_2` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_link_facebook`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_link_facebook` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_link_linkedin`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_link_linkedin` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_link_twitter`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_link_twitter` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_modules_fc`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_modules_fc` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_modules_fc_value` int(11) DEFAULT NULL COMMENT 'The field collection item id.',
  `field_modules_fc_revision_id` int(11) DEFAULT NULL COMMENT 'The field collection item revision id.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 37 (field_modules_fc)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_data_field_name`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_name` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_profession`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_profession` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_registration`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_registration` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_registration_value` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 41 (field_registration)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_data_field_specialty`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_specialty` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_tags`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_tags` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_text_bottom`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_text_bottom` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_text_headlight`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_text_headlight` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_text_middle`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_text_middle` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_text_top`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_text_top` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_title_custom`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_title_custom` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_title_custom_value` varchar(255) DEFAULT NULL,
  `field_title_custom_format` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 36 (field_title_custom)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_data_field_workload`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_workload` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_data_field_youtube`
--

CREATE TABLE IF NOT EXISTS `dfav_field_data_field_youtube` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_group`
--

CREATE TABLE IF NOT EXISTS `dfav_field_group` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table that contains field group entries and settings.' AUTO_INCREMENT=14 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_revision_body`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_body` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_alvo`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_alvo` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_area_ref`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_area_ref` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_area_ref_tid` int(10) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 40 (field_area_ref)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_revision_field_category`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_category` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_date`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_date` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_days_shifts`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_days_shifts` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_duration`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_duration` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `field_duration_value` varchar(100) DEFAULT NULL,
  `field_duration_format` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 39 (field_duration)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_revision_field_email`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_email` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_facilitator_nr`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_facilitator_nr` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_facilitator_nr_nid` int(10) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 33 (field_facilitator_nr)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_revision_field_file`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_file` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_image`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_image` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_info_fc`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_info_fc` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `field_info_fc_value` int(11) DEFAULT NULL COMMENT 'The field collection item id.',
  `field_info_fc_revision_id` int(11) DEFAULT NULL COMMENT 'The field collection item revision id.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 35 (field_info_fc)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_revision_field_info_left_sub_title`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_info_left_sub_title` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_info_left_title`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_info_left_title` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_info_right_sub_title`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_info_right_sub_title` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_info_right_title`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_info_right_title` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_investment`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_investment` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_link`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_link` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_links_fc`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_links_fc` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_link_2`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_link_2` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_link_facebook`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_link_facebook` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_link_linkedin`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_link_linkedin` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_link_twitter`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_link_twitter` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_modules_fc`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_modules_fc` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `field_modules_fc_value` int(11) DEFAULT NULL COMMENT 'The field collection item id.',
  `field_modules_fc_revision_id` int(11) DEFAULT NULL COMMENT 'The field collection item revision id.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 37 (field_modules_fc)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_revision_field_name`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_name` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_profession`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_profession` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_registration`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_registration` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_registration_value` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 41 (field_registration)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_revision_field_specialty`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_specialty` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_tags`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_tags` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_text_bottom`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_text_bottom` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_text_headlight`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_text_headlight` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_text_middle`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_text_middle` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_text_top`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_text_top` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_title_custom`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_title_custom` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `field_title_custom_value` varchar(255) DEFAULT NULL,
  `field_title_custom_format` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 36 (field_title_custom)';

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_field_revision_field_workload`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_workload` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_field_revision_field_youtube`
--

CREATE TABLE IF NOT EXISTS `dfav_field_revision_field_youtube` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Estrutura para tabela `dfav_file_managed`
--

CREATE TABLE IF NOT EXISTS `dfav_file_managed` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores information for uploaded files.' AUTO_INCREMENT=48 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_file_usage`
--

CREATE TABLE IF NOT EXISTS `dfav_file_usage` (
  `fid` int(10) unsigned NOT NULL COMMENT 'File ID.',
...
--
-- Estrutura para tabela `dfav_filter`
--

CREATE TABLE IF NOT EXISTS `dfav_filter` (
...
--
-- Estrutura para tabela `dfav_filter_format`
--

CREATE TABLE IF NOT EXISTS `dfav_filter_format` (
...
--
-- Estrutura para tabela `dfav_flood`
--

CREATE TABLE IF NOT EXISTS `dfav_flood` (
...
--
-- Estrutura para tabela `dfav_history`
--

CREATE TABLE IF NOT EXISTS `dfav_history` (
...
--
-- Estrutura para tabela `dfav_image_effects`
--

CREATE TABLE IF NOT EXISTS `dfav_image_effects` (
...
--
-- Estrutura para tabela `dfav_image_styles`
--

CREATE TABLE IF NOT EXISTS `dfav_image_styles` (
...
--
-- Estrutura para tabela `dfav_l10n_update_file`
--

CREATE TABLE IF NOT EXISTS `dfav_l10n_update_file` (
...
--
-- Estrutura para tabela `dfav_l10n_update_project`
--

CREATE TABLE IF NOT EXISTS `dfav_l10n_update_project` (
...
--
-- Estrutura para tabela `dfav_languages`
--

CREATE TABLE IF NOT EXISTS `dfav_languages` (
...
--
-- Estrutura para tabela `dfav_locales_source`
--

CREATE TABLE IF NOT EXISTS `dfav_locales_source` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='List of English source strings.' AUTO_INCREMENT=11023 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_locales_target`
--

CREATE TABLE IF NOT EXISTS `dfav_locales_target` (
...
--
-- Estrutura para tabela `dfav_menu_custom`
--

CREATE TABLE IF NOT EXISTS `dfav_menu_custom` (
...
--
-- Estrutura para tabela `dfav_menu_links`
--

CREATE TABLE IF NOT EXISTS `dfav_menu_links` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contains the individual links within a menu.' AUTO_INCREMENT=1198 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_menu_router`
--

CREATE TABLE IF NOT EXISTS `dfav_menu_router` (
...
--
-- Estrutura para tabela `dfav_metatag`
--

CREATE TABLE IF NOT EXISTS `dfav_metatag` (
...
--
-- Estrutura para tabela `dfav_metatag_config`
--

CREATE TABLE IF NOT EXISTS `dfav_metatag_config` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Storage of meta tag configuration and defaults.' AUTO_INCREMENT=2 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_node`
--

CREATE TABLE IF NOT EXISTS `dfav_node` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='The base table for nodes.' AUTO_INCREMENT=47 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_node_access`
--

CREATE TABLE IF NOT EXISTS `dfav_node_access` (
...
--
-- Estrutura para tabela `dfav_node_revision`
--

CREATE TABLE IF NOT EXISTS `dfav_node_revision` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores information about each saved version of a dfav_node.' AUTO_INCREMENT=47 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_node_type`
--

CREATE TABLE IF NOT EXISTS `dfav_node_type` (
...
--
-- Estrutura para tabela `dfav_pathauto_state`
--

CREATE TABLE IF NOT EXISTS `dfav_pathauto_state` (
...
--
-- Estrutura para tabela `dfav_queue`
--

CREATE TABLE IF NOT EXISTS `dfav_queue` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores items in queues.' AUTO_INCREMENT=330 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_registry`
--

CREATE TABLE IF NOT EXISTS `dfav_registry` (
...
--
-- Estrutura para tabela `dfav_registry_file`
--

CREATE TABLE IF NOT EXISTS `dfav_registry_file` (
...
--
-- Estrutura para tabela `dfav_role`
--

CREATE TABLE IF NOT EXISTS `dfav_role` (
...
--
-- Estrutura para tabela `dfav_role_permission`
--

CREATE TABLE IF NOT EXISTS `dfav_role_permission` (
...
--
-- Estrutura para tabela `dfav_semaphore`
--

CREATE TABLE IF NOT EXISTS `dfav_semaphore` (
...
--
-- Estrutura para tabela `dfav_sequences`
--

CREATE TABLE IF NOT EXISTS `dfav_sequences` (
`value` int(10) unsigned NOT NULL COMMENT 'The value of the sequence.'
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores IDs.' AUTO_INCREMENT=54 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_sessions`
--

CREATE TABLE IF NOT EXISTS `dfav_sessions` (
...
--
-- Estrutura para tabela `dfav_shortcut_set`
--

CREATE TABLE IF NOT EXISTS `dfav_shortcut_set` (
...
--
-- Estrutura para tabela `dfav_shortcut_set_users`
--

CREATE TABLE IF NOT EXISTS `dfav_shortcut_set_users` (
...
--
-- Estrutura para tabela `dfav_system`
--

CREATE TABLE IF NOT EXISTS `dfav_system` (
...
--
-- Estrutura para tabela `dfav_taxonomy_index`
--

CREATE TABLE IF NOT EXISTS `dfav_taxonomy_index` (
...
--
-- Estrutura para tabela `dfav_taxonomy_term_data`
--

CREATE TABLE IF NOT EXISTS `dfav_taxonomy_term_data` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores term information.' AUTO_INCREMENT=11 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_taxonomy_term_hierarchy`
--

CREATE TABLE IF NOT EXISTS `dfav_taxonomy_term_hierarchy` (
...
--
-- Estrutura para tabela `dfav_taxonomy_vocabulary`
--

CREATE TABLE IF NOT EXISTS `dfav_taxonomy_vocabulary` (
...
--
-- Estrutura para tabela `dfav_trigger_assignments`
--

CREATE TABLE IF NOT EXISTS `dfav_trigger_assignments` (
...
--
-- Estrutura para tabela `dfav_url_alias`
--

CREATE TABLE IF NOT EXISTS `dfav_url_alias` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='A list of URL aliases for Drupal paths; a user may visit...' AUTO_INCREMENT=57 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_users`
--

CREATE TABLE IF NOT EXISTS `dfav_users` (
...
--
-- Estrutura para tabela `dfav_users_roles`
--

CREATE TABLE IF NOT EXISTS `dfav_users_roles` (
...
--
-- Estrutura para tabela `dfav_variable`
--

CREATE TABLE IF NOT EXISTS `dfav_variable` (
...
--
-- Estrutura para tabela `dfav_variable_store`
--

CREATE TABLE IF NOT EXISTS `dfav_variable_store` (
...
--
-- Estrutura para tabela `dfav_views_display`
--

CREATE TABLE IF NOT EXISTS `dfav_views_display` (
...
--
-- Estrutura para tabela `dfav_views_view`
--

CREATE TABLE IF NOT EXISTS `dfav_views_view` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores the general data for a view.' AUTO_INCREMENT=11 ;

-- --------------------------------------------------------

--
-- Estrutura para tabela `dfav_watchdog`
--

CREATE TABLE IF NOT EXISTS `dfav_watchdog` (
...
--
-- Estrutura para tabela `dfav_webform`
--

CREATE TABLE IF NOT EXISTS `dfav_webform` (
...
--
-- Estrutura para tabela `dfav_webform_component`
--

CREATE TABLE IF NOT EXISTS `dfav_webform_component` (
...
--
-- Estrutura para tabela `dfav_webform_conditional`
--

CREATE TABLE IF NOT EXISTS `dfav_webform_conditional` (
  `nid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'The node identifier of a webform.',
...
--
-- Estrutura para tabela `dfav_webform_conditional_actions`
--

CREATE TABLE IF NOT EXISTS `dfav_webform_conditional_actions` (
  `nid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'The node identifier of a webform.',
  `rgid` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'The rule group identifier for this group of rules.',
...
--
-- Estrutura para tabela `dfav_webform_conditional_rules`
--

CREATE TABLE IF NOT EXISTS `dfav_webform_conditional_rules` (
  `nid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'The node identifier of a webform.',
  `rgid` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'The rule group identifier for this group of rules.',
...
--
-- Estrutura para tabela `dfav_webform_emails`
--

CREATE TABLE IF NOT EXISTS `dfav_webform_emails` (
  `nid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'The node identifier of a webform.',
...
--
-- Estrutura para tabela `dfav_webform_last_download`
--

CREATE TABLE IF NOT EXISTS `dfav_webform_last_download` (
  `nid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'The node identifier of a webform.',
...
--
-- Estrutura para tabela `dfav_webform_roles`
--

CREATE TABLE IF NOT EXISTS `dfav_webform_roles` (
  `nid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'The node identifier of a webform.',
...
--
-- Estrutura para tabela `dfav_webform_submissions`
--

CREATE TABLE IF NOT EXISTS `dfav_webform_submissions` (
...
--
-- Estrutura para tabela `dfav_webform_submitted_data`
--

CREATE TABLE IF NOT EXISTS `dfav_webform_submitted_data` (
  `nid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'The node identifier of a webform.',
...
--
-- Índices de tabela `dfav_actions`
--
ALTER TABLE `dfav_actions`
 ADD PRIMARY KEY (`aid`);

--
-- Índices de tabela `dfav_authmap`
--
ALTER TABLE `dfav_authmap`
 ADD PRIMARY KEY (`aid`), ADD UNIQUE KEY `authname` (`authname`), ADD KEY `uid_module` (`uid`,`module`);

--
-- Índices de tabela `dfav_batch`
--
ALTER TABLE `dfav_batch`
 ADD PRIMARY KEY (`bid`), ADD KEY `token` (`token`);

--
-- Índices de tabela `dfav_block`
--
...
--
-- Índices de tabela `dfav_blocked_ips`
--
ALTER TABLE `dfav_blocked_ips`
 ADD PRIMARY KEY (`iid`), ADD KEY `blocked_ip` (`ip`);

--
-- Índices de tabela `dfav_block_custom`
--
ALTER TABLE `dfav_block_custom`
 ADD PRIMARY KEY (`bid`), ADD UNIQUE KEY `info` (`info`);

--
-- Índices de tabela `dfav_block_node_type`
--
ALTER TABLE `dfav_block_node_type`
 ADD PRIMARY KEY (`module`,`delta`,`type`), ADD KEY `type` (`type`);

--
-- Índices de tabela `dfav_block_role`
--
ALTER TABLE `dfav_block_role`
 ADD PRIMARY KEY (`module`,`delta`,`rid`), ADD KEY `rid` (`rid`);

--
-- Índices de tabela `dfav_cache`
--
ALTER TABLE `dfav_cache`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_admin_menu`
--
ALTER TABLE `dfav_cache_admin_menu`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_block`
--
ALTER TABLE `dfav_cache_block`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_bootstrap`
--
ALTER TABLE `dfav_cache_bootstrap`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_field`
--
ALTER TABLE `dfav_cache_field`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_filter`
--
ALTER TABLE `dfav_cache_filter`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_form`
--
ALTER TABLE `dfav_cache_form`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_image`
--
ALTER TABLE `dfav_cache_image`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_libraries`
--
ALTER TABLE `dfav_cache_libraries`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_menu`
--
ALTER TABLE `dfav_cache_menu`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_metatag`
--
ALTER TABLE `dfav_cache_metatag`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_page`
--
ALTER TABLE `dfav_cache_page`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_path`
--
ALTER TABLE `dfav_cache_path`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_token`
--
ALTER TABLE `dfav_cache_token`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_update`
--
ALTER TABLE `dfav_cache_update`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_variable`
--
ALTER TABLE `dfav_cache_variable`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_views`
--
ALTER TABLE `dfav_cache_views`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_cache_views_data`
--
ALTER TABLE `dfav_cache_views_data`
 ADD PRIMARY KEY (`cid`), ADD KEY `expire` (`expire`);

--
-- Índices de tabela `dfav_ckeditor_input_format`
--
ALTER TABLE `dfav_ckeditor_input_format`
 ADD PRIMARY KEY (`name`,`format`);

--
-- Índices de tabela `dfav_ckeditor_settings`
--
ALTER TABLE `dfav_ckeditor_settings`
 ADD PRIMARY KEY (`name`);

--
-- Índices de tabela `dfav_clientside_validation_settings`
--
ALTER TABLE `dfav_clientside_validation_settings`
 ADD PRIMARY KEY (`cvsid`), ADD UNIQUE KEY `cvs_form_id` (`form_id`), ADD KEY `clientside_validation_settings_form_id` (`form_id`), ADD KEY `clientside_validation_settings_type` (`type`), ADD KEY `clientside_validation_settings_form_id_type` (`form_id`,`type`);

--
-- Índices de tabela `dfav_conditional_fields`
--
ALTER TABLE `dfav_conditional_fields`
 ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `dfav_ctools_css_cache`
--
ALTER TABLE `dfav_ctools_css_cache`
 ADD PRIMARY KEY (`cid`);

--
-- Índices de tabela `dfav_ctools_object_cache`
--
ALTER TABLE `dfav_ctools_object_cache`
 ADD PRIMARY KEY (`sid`,`obj`,`name`), ADD KEY `updated` (`updated`);

--
-- Índices de tabela `dfav_date_formats`
--
ALTER TABLE `dfav_date_formats`
 ADD PRIMARY KEY (`dfid`), ADD UNIQUE KEY `formats` (`format`,`type`);

--
-- Índices de tabela `dfav_date_format_locale`
--
ALTER TABLE `dfav_date_format_locale`
 ADD PRIMARY KEY (`type`,`language`);

--
-- Índices de tabela `dfav_date_format_type`
--
ALTER TABLE `dfav_date_format_type`
 ADD PRIMARY KEY (`type`), ADD KEY `title` (`title`);

--
-- Índices de tabela `dfav_ds_fields`
--
ALTER TABLE `dfav_ds_fields`
 ADD PRIMARY KEY (`field`);

--
-- Índices de tabela `dfav_ds_field_settings`
--
ALTER TABLE `dfav_ds_field_settings`
 ADD PRIMARY KEY (`id`), ADD KEY `ds_entity` (`entity_type`), ADD KEY `ds_bundle` (`bundle`), ADD KEY `ds_view_mode` (`view_mode`);

--
-- Índices de tabela `dfav_ds_layout_settings`
--
ALTER TABLE `dfav_ds_layout_settings`
 ADD PRIMARY KEY (`id`), ADD KEY `ds_entity` (`entity_type`), ADD KEY `ds_bundle` (`bundle`), ADD KEY `ds_view_mode` (`view_mode`);

--
-- Índices de tabela `dfav_ds_vd`
--
ALTER TABLE `dfav_ds_vd`
 ADD PRIMARY KEY (`vd`);

--
-- Índices de tabela `dfav_ds_view_modes`
--
ALTER TABLE `dfav_ds_view_modes`
 ADD PRIMARY KEY (`view_mode`);

--
-- Índices de tabela `dfav_field_collection_item`
--
ALTER TABLE `dfav_field_collection_item`
 ADD PRIMARY KEY (`item_id`);

--
-- Índices de tabela `dfav_field_collection_item_revision`
--
ALTER TABLE `dfav_field_collection_item_revision`
 ADD PRIMARY KEY (`revision_id`), ADD KEY `item_id` (`item_id`);

--
-- Índices de tabela `dfav_field_config`
--
...
--
-- Índices de tabela `dfav_field_config_instance`
--
...
--
-- Índices de tabela `dfav_field_data_body`
--
...
--
-- Índices de tabela `dfav_field_data_field_alvo`
--
ALTER TABLE `dfav_field_data_field_alvo`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_alvo_value` (`field_alvo_value`);

--
-- Índices de tabela `dfav_field_data_field_area_ref`
--
ALTER TABLE `dfav_field_data_field_area_ref`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_area_ref_tid` (`field_area_ref_tid`);

--
-- Índices de tabela `dfav_field_data_field_category`
--
ALTER TABLE `dfav_field_data_field_category`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_category_value` (`field_category_value`);

--
-- Índices de tabela `dfav_field_data_field_date`
--
...
--
-- Índices de tabela `dfav_field_data_field_days_shifts`
--
ALTER TABLE `dfav_field_data_field_days_shifts`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_days_shifts_format` (`field_days_shifts_format`);

--
-- Índices de tabela `dfav_field_data_field_duration`
--
ALTER TABLE `dfav_field_data_field_duration`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_duration_format` (`field_duration_format`);

--
-- Índices de tabela `dfav_field_data_field_email`
--
ALTER TABLE `dfav_field_data_field_email`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_data_field_facilitator_nr`
--
ALTER TABLE `dfav_field_data_field_facilitator_nr`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_facilitator_nr_nid` (`field_facilitator_nr_nid`);

--
-- Índices de tabela `dfav_field_data_field_file`
--
ALTER TABLE `dfav_field_data_field_file`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_file_fid` (`field_file_fid`);

--
-- Índices de tabela `dfav_field_data_field_image`
--
...
--
-- Índices de tabela `dfav_field_data_field_info_fc`
--
ALTER TABLE `dfav_field_data_field_info_fc`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_info_fc_value` (`field_info_fc_value`), ADD KEY `field_info_fc_revision_id` (`field_info_fc_revision_id`);

--
-- Índices de tabela `dfav_field_data_field_info_left_sub_title`
--
ALTER TABLE `dfav_field_data_field_info_left_sub_title`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_info_left_sub_title_format` (`field_info_left_sub_title_format`);

--
-- Índices de tabela `dfav_field_data_field_info_left_title`
--
ALTER TABLE `dfav_field_data_field_info_left_title`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_info_left_title_format` (`field_info_left_title_format`);

--
-- Índices de tabela `dfav_field_data_field_info_right_sub_title`
--
ALTER TABLE `dfav_field_data_field_info_right_sub_title`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_info_right_sub_title_format` (`field_info_right_sub_title_format`);

--
-- Índices de tabela `dfav_field_data_field_info_right_title`
--
ALTER TABLE `dfav_field_data_field_info_right_title`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_info_right_title_format` (`field_info_right_title_format`);

--
-- Índices de tabela `dfav_field_data_field_investment`
--
ALTER TABLE `dfav_field_data_field_investment`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_investment_format` (`field_investment_format`);

--
-- Índices de tabela `dfav_field_data_field_link`
--
ALTER TABLE `dfav_field_data_field_link`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_data_field_links_fc`
--
ALTER TABLE `dfav_field_data_field_links_fc`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_links_fc_value` (`field_links_fc_value`), ADD KEY `field_links_fc_revision_id` (`field_links_fc_revision_id`);

--
-- Índices de tabela `dfav_field_data_field_link_2`
--
ALTER TABLE `dfav_field_data_field_link_2`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_data_field_link_facebook`
--
ALTER TABLE `dfav_field_data_field_link_facebook`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_data_field_link_linkedin`
--
ALTER TABLE `dfav_field_data_field_link_linkedin`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_data_field_link_twitter`
--
ALTER TABLE `dfav_field_data_field_link_twitter`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_data_field_modules_fc`
--
ALTER TABLE `dfav_field_data_field_modules_fc`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_modules_fc_value` (`field_modules_fc_value`), ADD KEY `field_modules_fc_revision_id` (`field_modules_fc_revision_id`);

--
-- Índices de tabela `dfav_field_data_field_name`
--
...
--
-- Índices de tabela `dfav_field_data_field_profession`
--
ALTER TABLE `dfav_field_data_field_profession`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_profession_format` (`field_profession_format`);

--
-- Índices de tabela `dfav_field_data_field_registration`
--
ALTER TABLE `dfav_field_data_field_registration`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_registration_value` (`field_registration_value`);

--
-- Índices de tabela `dfav_field_data_field_specialty`
--
ALTER TABLE `dfav_field_data_field_specialty`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_specialty_format` (`field_specialty_format`);

--
-- Índices de tabela `dfav_field_data_field_tags`
--
...
--
-- Índices de tabela `dfav_field_data_field_text_bottom`
--
ALTER TABLE `dfav_field_data_field_text_bottom`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_text_bottom_format` (`field_text_bottom_format`);

--
-- Índices de tabela `dfav_field_data_field_text_headlight`
--
ALTER TABLE `dfav_field_data_field_text_headlight`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_text_headlight_format` (`field_text_headlight_format`);

--
-- Índices de tabela `dfav_field_data_field_text_middle`
--
ALTER TABLE `dfav_field_data_field_text_middle`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_text_middle_format` (`field_text_middle_format`);

--
-- Índices de tabela `dfav_field_data_field_text_top`
--
ALTER TABLE `dfav_field_data_field_text_top`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_text_top_format` (`field_text_top_format`);

--
-- Índices de tabela `dfav_field_data_field_title_custom`
--
ALTER TABLE `dfav_field_data_field_title_custom`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_title_custom_format` (`field_title_custom_format`);

--
-- Índices de tabela `dfav_field_data_field_workload`
--
ALTER TABLE `dfav_field_data_field_workload`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_workload_format` (`field_workload_format`);

--
-- Índices de tabela `dfav_field_data_field_youtube`
--
ALTER TABLE `dfav_field_data_field_youtube`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_youtube_video_id` (`field_youtube_video_id`);

--
-- Índices de tabela `dfav_field_group`
--
ALTER TABLE `dfav_field_group`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `identifier` (`identifier`), ADD KEY `group_name` (`group_name`);

--
-- Índices de tabela `dfav_field_revision_body`
--
...
--
-- Índices de tabela `dfav_field_revision_field_alvo`
--
ALTER TABLE `dfav_field_revision_field_alvo`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_alvo_value` (`field_alvo_value`);

--
-- Índices de tabela `dfav_field_revision_field_area_ref`
--
ALTER TABLE `dfav_field_revision_field_area_ref`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_area_ref_tid` (`field_area_ref_tid`);

--
-- Índices de tabela `dfav_field_revision_field_category`
--
ALTER TABLE `dfav_field_revision_field_category`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_category_value` (`field_category_value`);

--
-- Índices de tabela `dfav_field_revision_field_date`
--
...
--
-- Índices de tabela `dfav_field_revision_field_days_shifts`
--
ALTER TABLE `dfav_field_revision_field_days_shifts`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_days_shifts_format` (`field_days_shifts_format`);

--
-- Índices de tabela `dfav_field_revision_field_duration`
--
ALTER TABLE `dfav_field_revision_field_duration`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_duration_format` (`field_duration_format`);

--
-- Índices de tabela `dfav_field_revision_field_email`
--
ALTER TABLE `dfav_field_revision_field_email`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_revision_field_facilitator_nr`
--
ALTER TABLE `dfav_field_revision_field_facilitator_nr`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_facilitator_nr_nid` (`field_facilitator_nr_nid`);

--
-- Índices de tabela `dfav_field_revision_field_file`
--
ALTER TABLE `dfav_field_revision_field_file`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_file_fid` (`field_file_fid`);

--
-- Índices de tabela `dfav_field_revision_field_image`
--
...
--
-- Índices de tabela `dfav_field_revision_field_info_fc`
--
ALTER TABLE `dfav_field_revision_field_info_fc`
...
--
-- Índices de tabela `dfav_field_revision_field_info_left_sub_title`
--
ALTER TABLE `dfav_field_revision_field_info_left_sub_title`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_info_left_sub_title_format` (`field_info_left_sub_title_format`);

--
-- Índices de tabela `dfav_field_revision_field_info_left_title`
--
ALTER TABLE `dfav_field_revision_field_info_left_title`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_info_left_title_format` (`field_info_left_title_format`);

--
-- Índices de tabela `dfav_field_revision_field_info_right_sub_title`
--
ALTER TABLE `dfav_field_revision_field_info_right_sub_title`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_info_right_sub_title_format` (`field_info_right_sub_title_format`);

--
-- Índices de tabela `dfav_field_revision_field_info_right_title`
--
ALTER TABLE `dfav_field_revision_field_info_right_title`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_info_right_title_format` (`field_info_right_title_format`);

--
-- Índices de tabela `dfav_field_revision_field_investment`
--
ALTER TABLE `dfav_field_revision_field_investment`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_investment_format` (`field_investment_format`);

--
-- Índices de tabela `dfav_field_revision_field_link`
--
ALTER TABLE `dfav_field_revision_field_link`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_revision_field_links_fc`
--
ALTER TABLE `dfav_field_revision_field_links_fc`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_links_fc_value` (`field_links_fc_value`), ADD KEY `field_links_fc_revision_id` (`field_links_fc_revision_id`);

--
-- Índices de tabela `dfav_field_revision_field_link_2`
--
ALTER TABLE `dfav_field_revision_field_link_2`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_revision_field_link_facebook`
--
ALTER TABLE `dfav_field_revision_field_link_facebook`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_revision_field_link_linkedin`
--
ALTER TABLE `dfav_field_revision_field_link_linkedin`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_revision_field_link_twitter`
--
ALTER TABLE `dfav_field_revision_field_link_twitter`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`);

--
-- Índices de tabela `dfav_field_revision_field_modules_fc`
--
ALTER TABLE `dfav_field_revision_field_modules_fc`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_modules_fc_value` (`field_modules_fc_value`), ADD KEY `field_modules_fc_revision_id` (`field_modules_fc_revision_id`);

--
-- Índices de tabela `dfav_field_revision_field_name`
--
...
--
-- Índices de tabela `dfav_field_revision_field_profession`
--
ALTER TABLE `dfav_field_revision_field_profession`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_profession_format` (`field_profession_format`);

--
-- Índices de tabela `dfav_field_revision_field_registration`
--
ALTER TABLE `dfav_field_revision_field_registration`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_registration_value` (`field_registration_value`);

--
-- Índices de tabela `dfav_field_revision_field_specialty`
--
ALTER TABLE `dfav_field_revision_field_specialty`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_specialty_format` (`field_specialty_format`);

--
-- Índices de tabela `dfav_field_revision_field_tags`
--
...
--
-- Índices de tabela `dfav_field_revision_field_text_bottom`
--
ALTER TABLE `dfav_field_revision_field_text_bottom`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_text_bottom_format` (`field_text_bottom_format`);

--
-- Índices de tabela `dfav_field_revision_field_text_headlight`
--
ALTER TABLE `dfav_field_revision_field_text_headlight`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_text_headlight_format` (`field_text_headlight_format`);

--
-- Índices de tabela `dfav_field_revision_field_text_middle`
--
ALTER TABLE `dfav_field_revision_field_text_middle`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_text_middle_format` (`field_text_middle_format`);

--
-- Índices de tabela `dfav_field_revision_field_text_top`
--
ALTER TABLE `dfav_field_revision_field_text_top`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_text_top_format` (`field_text_top_format`);

--
-- Índices de tabela `dfav_field_revision_field_title_custom`
--
ALTER TABLE `dfav_field_revision_field_title_custom`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_title_custom_format` (`field_title_custom_format`);

--
-- Índices de tabela `dfav_field_revision_field_workload`
--
ALTER TABLE `dfav_field_revision_field_workload`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_workload_format` (`field_workload_format`);

--
-- Índices de tabela `dfav_field_revision_field_youtube`
--
ALTER TABLE `dfav_field_revision_field_youtube`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`deleted`,`delta`,`language`), ADD KEY `entity_type` (`entity_type`), ADD KEY `bundle` (`bundle`), ADD KEY `deleted` (`deleted`), ADD KEY `entity_id` (`entity_id`), ADD KEY `revision_id` (`revision_id`), ADD KEY `language` (`language`), ADD KEY `field_youtube_video_id` (`field_youtube_video_id`);

--
-- Índices de tabela `dfav_file_managed`
--
...
--
-- Índices de tabela `dfav_file_usage`
--
...
--
-- Índices de tabela `dfav_menu_custom`
--
ALTER TABLE `dfav_menu_custom`
 ADD PRIMARY KEY (`menu_name`);

--
-- Índices de tabela `dfav_menu_links`
--
...
--
-- Índices de tabela `dfav_menu_router`
--
...
--
-- Índices de tabela `dfav_metatag`
--
ALTER TABLE `dfav_metatag`
 ADD PRIMARY KEY (`entity_type`,`entity_id`,`revision_id`,`language`), ADD KEY `type_revision` (`entity_type`,`revision_id`);

--
-- Índices de tabela `dfav_metatag_config`
--
ALTER TABLE `dfav_metatag_config`
 ADD PRIMARY KEY (`cid`), ADD UNIQUE KEY `instance` (`instance`);

--
-- Índices de tabela `dfav_node`
--
...
--
-- Índices de tabela `dfav_taxonomy_term_hierarchy`
--
ALTER TABLE `dfav_taxonomy_term_hierarchy`
 ADD PRIMARY KEY (`tid`,`parent`), ADD KEY `parent` (`parent`);

--
-- Índices de tabela `dfav_taxonomy_vocabulary`
--
...
--
-- Índices de tabela `dfav_trigger_assignments`
--
ALTER TABLE `dfav_trigger_assignments`
 ADD PRIMARY KEY (`hook`,`aid`);

--
-- Índices de tabela `dfav_url_alias`
--
...
--
-- Índices de tabela `dfav_users_roles`
--
ALTER TABLE `dfav_users_roles`
 ADD PRIMARY KEY (`uid`,`rid`), ADD KEY `rid` (`rid`);

--
-- Índices de tabela `dfav_variable`
--
ALTER TABLE `dfav_variable`
 ADD PRIMARY KEY (`name`);

--
-- Índices de tabela `dfav_variable_store`
--
ALTER TABLE `dfav_variable_store`
 ADD PRIMARY KEY (`realm`,`realm_key`,`name`), ADD KEY `realm_value` (`realm`,`realm_key`);

--
-- Índices de tabela `dfav_views_display`
--
ALTER TABLE `dfav_views_display`
 ADD PRIMARY KEY (`vid`,`id`), ADD KEY `vid` (`vid`,`position`);

--
-- Índices de tabela `dfav_views_view`
--
ALTER TABLE `dfav_views_view`
 ADD PRIMARY KEY (`vid`), ADD UNIQUE KEY `name` (`name`);

--
-- Índices de tabela `dfav_watchdog`
--
ALTER TABLE `dfav_watchdog`
 ADD PRIMARY KEY (`wid`), ADD KEY `type` (`type`), ADD KEY `uid` (`uid`), ADD KEY `severity` (`severity`);

--
-- Índices de tabela `dfav_webform`
--
ALTER TABLE `dfav_webform`
 ADD PRIMARY KEY (`nid`);

--
-- Índices de tabela `dfav_webform_component`
--
ALTER TABLE `dfav_webform_component`
 ADD PRIMARY KEY (`nid`,`cid`);

--
-- Índices de tabela `dfav_webform_conditional`
--
ALTER TABLE `dfav_webform_conditional`
 ADD PRIMARY KEY (`nid`,`rgid`);

--
-- Índices de tabela `dfav_webform_conditional_actions`
--
ALTER TABLE `dfav_webform_conditional_actions`
 ADD PRIMARY KEY (`nid`,`rgid`,`aid`);

--
-- Índices de tabela `dfav_webform_conditional_rules`
--
ALTER TABLE `dfav_webform_conditional_rules`
 ADD PRIMARY KEY (`nid`,`rgid`,`rid`);

--
-- Índices de tabela `dfav_webform_emails`
--
ALTER TABLE `dfav_webform_emails`
 ADD PRIMARY KEY (`nid`,`eid`);

--
-- Índices de tabela `dfav_webform_last_download`
--
ALTER TABLE `dfav_webform_last_download`
 ADD PRIMARY KEY (`nid`,`uid`);

--
-- Índices de tabela `dfav_webform_roles`
--
ALTER TABLE `dfav_webform_roles`
 ADD PRIMARY KEY (`nid`,`rid`);

--
-- Índices de tabela `dfav_webform_submissions`
--
ALTER TABLE `dfav_webform_submissions`
 ADD PRIMARY KEY (`sid`), ADD UNIQUE KEY `sid_nid` (`sid`,`nid`), ADD UNIQUE KEY `nid_serial` (`nid`,`serial`), ADD KEY `nid_uid_sid` (`nid`,`uid`,`sid`), ADD KEY `nid_sid` (`nid`,`sid`);

--
-- Índices de tabela `dfav_webform_submitted_data`
--
ALTER TABLE `dfav_webform_submitted_data`
 ADD PRIMARY KEY (`nid`,`sid`,`cid`,`no`), ADD KEY `nid` (`nid`), ADD KEY `sid_nid` (`sid`,`nid`), ADD KEY `data` (`data`(64));
...
--
-- AUTO_INCREMENT de tabela `dfav_authmap`
--
ALTER TABLE `dfav_authmap`
MODIFY `aid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique authmap ID.';
--
-- AUTO_INCREMENT de tabela `dfav_block`
--
ALTER TABLE `dfav_block`
MODIFY `bid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique block ID.',AUTO_INCREMENT=163;
--
-- AUTO_INCREMENT de tabela `dfav_blocked_ips`
--
ALTER TABLE `dfav_blocked_ips`
MODIFY `iid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: unique ID for IP addresses.';
--
-- AUTO_INCREMENT de tabela `dfav_block_custom`
--
ALTER TABLE `dfav_block_custom`
MODIFY `bid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The block’s dfav_block.bid.',AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de tabela `dfav_clientside_validation_settings`
--
ALTER TABLE `dfav_clientside_validation_settings`
...
--
-- AUTO_INCREMENT de tabela `dfav_conditional_fields`
--
ALTER TABLE `dfav_conditional_fields`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'The primary identifier for a dependency.',AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT de tabela `dfav_date_formats`
--
ALTER TABLE `dfav_date_formats`
MODIFY `dfid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The date format identifier.',AUTO_INCREMENT=36;
--
-- AUTO_INCREMENT de tabela `dfav_field_collection_item`
--
ALTER TABLE `dfav_field_collection_item`
MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique field collection item ID.',AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT de tabela `dfav_field_collection_item_revision`
--
ALTER TABLE `dfav_field_collection_item_revision`
MODIFY `revision_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique revision ID.',AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT de tabela `dfav_field_config`
--
ALTER TABLE `dfav_field_config`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'The primary identifier for a field',AUTO_INCREMENT=42;
--
-- AUTO_INCREMENT de tabela `dfav_field_config_instance`
--
ALTER TABLE `dfav_field_config_instance`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'The primary identifier for a field instance',AUTO_INCREMENT=84;
--
-- AUTO_INCREMENT de tabela `dfav_field_group`
--
ALTER TABLE `dfav_field_group`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'The primary identifier for a group',AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de tabela `dfav_file_managed`
--
ALTER TABLE `dfav_file_managed`
MODIFY `fid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'File ID.',AUTO_INCREMENT=48;
--
-- AUTO_INCREMENT de tabela `dfav_flood`
--
ALTER TABLE `dfav_flood`
MODIFY `fid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique flood event ID.',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `dfav_image_effects`
--
ALTER TABLE `dfav_image_effects`
MODIFY `ieid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The primary identifier for an image effect.',AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de tabela `dfav_image_styles`
--
ALTER TABLE `dfav_image_styles`
MODIFY `isid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The primary identifier for an image style.',AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de tabela `dfav_locales_source`
--
ALTER TABLE `dfav_locales_source`
MODIFY `lid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier of this string.',AUTO_INCREMENT=11023;
--
-- AUTO_INCREMENT de tabela `dfav_menu_links`
--
ALTER TABLE `dfav_menu_links`
MODIFY `mlid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The menu link ID (mlid) is the integer primary key.',AUTO_INCREMENT=1198;
--
-- AUTO_INCREMENT de tabela `dfav_metatag_config`
--
ALTER TABLE `dfav_metatag_config`
...
--
-- AUTO_INCREMENT de tabela `dfav_node`
--
ALTER TABLE `dfav_node`
MODIFY `nid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The primary identifier for a node.',AUTO_INCREMENT=47;
--
-- AUTO_INCREMENT de tabela `dfav_node_revision`
--
ALTER TABLE `dfav_node_revision`
MODIFY `vid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The primary identifier for this version.',AUTO_INCREMENT=47;
--
-- AUTO_INCREMENT de tabela `dfav_queue`
--
ALTER TABLE `dfav_queue`
MODIFY `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique item ID.',AUTO_INCREMENT=330;
--
-- AUTO_INCREMENT de tabela `dfav_role`
--
ALTER TABLE `dfav_role`
MODIFY `rid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique role ID.',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de tabela `dfav_sequences`
--
ALTER TABLE `dfav_sequences`
MODIFY `value` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The value of the sequence.',AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT de tabela `dfav_taxonomy_term_data`
--
ALTER TABLE `dfav_taxonomy_term_data`
MODIFY `tid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique term ID.',AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de tabela `dfav_taxonomy_vocabulary`
--
ALTER TABLE `dfav_taxonomy_vocabulary`
MODIFY `vid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique vocabulary ID.',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de tabela `dfav_url_alias`
--
ALTER TABLE `dfav_url_alias`
MODIFY `pid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'A unique path alias identifier.',AUTO_INCREMENT=57;
--
-- AUTO_INCREMENT de tabela `dfav_views_view`
--
ALTER TABLE `dfav_views_view`
MODIFY `vid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'The view ID of the field, defined by the database.',AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de tabela `dfav_watchdog`
--
ALTER TABLE `dfav_watchdog`
MODIFY `wid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique watchdog event ID.',AUTO_INCREMENT=44;
--
-- AUTO_INCREMENT de tabela `dfav_webform_submissions`
--
ALTER TABLE `dfav_webform_submissions`
